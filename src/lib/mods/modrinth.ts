...
export function downloadMod(paths: object, serverName: string, file: object, modloader: ModloaderType) {
    const finalPath = paths.mcServerDirectory +  `/${serverName}/` + (modloader === ModloaderType.Paper || modloader === ModloaderType.Folia ? "plugins/" : "mods/")
