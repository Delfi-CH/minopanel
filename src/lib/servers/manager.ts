...
export class ActiveServerInstance {
	...
	spawn() {
		const bin =
			this.base.modloader.type === ModloaderType.Forge ||
			this.base.modloader.type === ModloaderType.NeoForge
				? this.base.serverExecutableFilePath
				: this.java.pathOnDisk + '/bin/java';
		if (!bin) {
